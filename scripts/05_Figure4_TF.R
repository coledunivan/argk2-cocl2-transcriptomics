...
rna_file  <- find_first(c("data/reference/RNAseq_to_TF_Targets*.csv", "data/reference/RNAseq_to_TF_Targets*.csv.gz", "RNAseq_to_TF_Targets*.csv", "RNAseq_to_TF_Targets*.csv.gz", "*TF_Targets*.csv"), "counts")
