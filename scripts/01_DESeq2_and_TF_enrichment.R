...
# Resolve the TFLink/count matrix, preferring the uncompressed copy but
# falling back to the gzipped copy shipped in the GitHub repo.
...
merged <- read.csv(resolve_tflink(),
